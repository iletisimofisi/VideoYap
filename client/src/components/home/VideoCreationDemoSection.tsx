        ...
        <div className="bg-darkSurface rounded-xl shadow-xl p-6 lg:p-8 max-w-4xl mx-auto">
          <div className="mb-6">
            ...
            <Textarea 
              ...
              className="w-full px-4 py-3 rounded-lg bg-darkBg border border-darkBorder text-white focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none min-h-[120px] placeholder:text-gray-500" 
